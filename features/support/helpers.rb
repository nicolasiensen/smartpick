...
def to_element string
  ...
  return 'form.new_compare input[name="car_name_1"]'  if string == 'the first comparison car field'
  return 'form.new_compare input[name="car_name_2"]'  if string == 'the second comparison car field'
  raise "I don't know what '#{string}' means"
end
